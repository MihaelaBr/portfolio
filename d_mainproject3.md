	...
	<section>
		...
		<div class="content">
			<div class="inner">
				...
				<ul class="actions">
					<li>a href="https://public.tableau.com/views/CyclisticCaseStudy_17210605199230/CyclisticCaseStudy?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link" class="button">Tableau Public Dashboard</a></li>
				</ul>
			</div>
		</div>
	</section>
